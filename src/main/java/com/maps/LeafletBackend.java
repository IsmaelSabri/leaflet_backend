...
/*@SpringBootApplication(scanBasePackages = { "boot.registration" }, exclude = { SecurityAutoConfiguration.class,
		JpaRepositoriesAutoConfiguration.class })*/
@SpringBootApplication//(exclude = { SecurityAutoConfiguration.class })
public class LeafletBackend {

	public static void main(String[] args) {
		SpringApplication.run(LeafletBackend.class, args);
	}
